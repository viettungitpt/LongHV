...
Class Mfeedback extends MY_Model
{
    ...
    public function getFeedbackDB($number,$offset)
    {
        $limit = $offset ? intval($offset) : '0';
        $sql  = '';
        $sql = "SELECT * FROM phanhoi WHERE  1=1 ORDER BY ngayTao DESC";
	...
	public function deleteFeedbackID($id){
		$this->db->delete('phanhoi', array('maPhanHoi' => $id));
        return 200;
	}
	
	public function getFeedbackInfo($id){
		return $this->db->query("SELECT * FROM phanhoi WHERE maPhanHoi = '".$id."'")->row_object();
	}
	
	public function editFeedbackDb($name,$mobile,$email,$address,$title,$content,$active,$id){
		$data = array(
			'hoTen' => $name,
			'soDienThoai' => $mobile,
            'diaChiEmail' => $email,
        ...
        $this->db->update('phanhoi', $data, "maPhanHoi = ".$id);
        return 200;
	}
