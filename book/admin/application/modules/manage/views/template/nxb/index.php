...
<div class="pagetitle">
	<h1>Danh sách nhà xuất bản</h1> <span></span>
</div>
<div class="maincontent">
    <div class="contentinner">    
        <?php $attr = array('class' => 'stdform','id' => 'form-list','method' => 'get'); echo form_open('', $attr);?>
        <div id="filter" class="dataTables_length">
			<a href="<?php echo $baseurl.'nha-xuat-ban/them-nha-xuat-ban'?>" class="btn"><i class="icon-plus"></i> Thêm mới</a>
    	...
    	<table class="table table-bordered">
            ...
            ?>
                <tr>
					...
					<td>
						<?php echo $le->tenNhaXuatBan;?>
                    </td>
                    <td class="centeralign">
                        <a href="<?php echo $baseurl.'nha-xuat-ban/sua-nha-xuat-ban/'.$le->maNhaXuatBan?>" class=""><span class="icon-edit"></span></a>
                        <a href="<?php echo $baseurl.'nha-xuat-ban/xoa-nha-xuat-ban/'.$le->maNhaXuatBan?>" class="delete-a"><span class="icon-trash"></span></a>   
                    </td>
                </tr>
            <?php endforeach;?>
            <?php endif?>
