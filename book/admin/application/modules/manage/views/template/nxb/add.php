...
<div class="pagetitle">
	<h1>Thêm nhà xuất bản</h1> <span></span>
</div>
<div class="maincontent">
    ...
    <p>
        ...
        <span class="field"><input type="text" value="<?php echo $this->input->post('tenNhaXuatBan');?>" name="tenNhaXuatBan" class="input-xlarge" placeholder="Tên nhà xuất bản" /></span>
    </p>
    <p>
        <label></label>
