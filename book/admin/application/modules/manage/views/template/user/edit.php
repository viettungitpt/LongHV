...
<div class="pagetitle">
	<h1 style="width: 100%;">Cập nhật người dùng </h1> <span></span>
</div>
<div class="maincontent">
	...
	<p>
    	<label>Số tiền (*)</label>
        <span class="field"><input type="number" value="<?php echo $data->coin?>" name="coin" class="input-xlarge" placeholder="Số tiền..." /></span>
    </p>
	
	<p>
    	<label>Mật khẩu mới (*)</label>
        <span class="field"><input type="text" value="" name="matKhau" class="input-xlarge" placeholder="Mật khẩu mới..." /></span>
    </p>
