<div class="breadcrumbwidget">
	...
	<ul class="breadcrumb">
        ...
        <li class="active">Cập nhật thông tin tác giả</li>
    </ul>
</div><!--breadcrumbwidget-->
<div class="pagetitle">
	<h1 style="width: 100%;">Cập nhật tác giả </h1> <span></span>
</div>
<div class="maincontent">
	...
	<p>
        ...
        <span class="field"><input type="text" value="<?php echo $data->tenTacGia?>" name="tenTacGia" class="input-xlarge" placeholder="Tên tác giả..." /></span>
    </p>
