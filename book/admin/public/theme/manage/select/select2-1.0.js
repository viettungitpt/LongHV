            ...
            init: function () {
                ...
                this.container.html(
                    "   <a href='javascript:void(0)' class='select2-choice'>" +
                        ...
                        "   <div><b></b></div>" +
                        "</a>" +
                        "<div class='select2-drop' id='select2-drop"+this.el.attr("name")+"' style='display:none;'>" +
                ...
                this.container.find("input[type=hidden]").attr("id", this.el.attr("name")+'data');
