...
Class Mproduct extends MY_Model
{
	...
	public function namecategories($idSanPham){
		return $this->db->query('SELECT d.tenDanhMuc FROM danhmuc as d inner join sanpham as s on s.id_MaDanhMuc = d.maDanhMuc WHERE s.maSanPham = '.$idSanPham.'  ')->row_object()->tenDanhMuc;
	}
